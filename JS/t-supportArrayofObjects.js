...
const techImages = [
...

    {
        ...
        photo: 'images/editedTeleHowTos/3Lead.jpg',
    },
    ...
    },
    {
        ...
        photo: 'images/editedTeleHowTos/checkID.jpg',
    },
    {
        ...
        photo: 'images/editedTeleHowTos/sp02Mode.png',
    },
    {
        ...
        photo: 'images/editedTeleHowTos/noDataTeleError.png',
    },
    {
        name: 'Monitor Alarm<br> Check Sync-Out Cable',
        about: '<p>First check the cable connections in the back of the monitor to ensure each are plugged in correctly.</p><p>With this particular alarm I have found that it is usually the cable in the image below. What I ended up doing that cleared the alarm was taking this cable from another monitor not in use and using it as a replacement. Then I put in a biomed request for the monitor with the faulty cable.</p><p>However this should not be practiced routinely. If you get this error just double check your cable connections and contact biomed.</p>',
        photo: 'images/editedTeleHowTos/syncOutCable.jpg',
    },
    {
